...
znote-mcp is an MCP (Model Context Protocol) server implementing Zettelkasten knowledge management. It provides 19 tools for creating, linking, searching, and synthesizing atomic notes through Claude and other MCP-compatible clients.
...
| `src/znote_mcp/server/mcp_server.py` | MCP server with 19 tools registered via decorators |
